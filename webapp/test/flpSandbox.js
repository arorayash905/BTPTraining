					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP BTP Training CG",
									"targetURL": "#btptraining-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"btptraining-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=btptraining",
									"url": sap.ui.require.toUrl("btptraining")
								}
							}
						}
					}
